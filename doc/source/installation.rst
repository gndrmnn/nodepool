...
You should have a Jenkins server running with the `ZMQ Event Publisher`_
...
The logging configuration file is in the standard python logging `configuration file format`_.
