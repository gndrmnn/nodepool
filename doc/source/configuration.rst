...
**optional**
  ...
  ``availability-zones`` (list)
    ...
    If you have more than one availability zone, you should specify them all here,
    rather than letting one get selected by nova. By doing so, you allow
    nodepool to group all nodes allocated for a node request into the same zone,
    which will be selected at random from the list. If you do not list your zones
    here, this grouping cannot be guaranteed.
