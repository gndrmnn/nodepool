...
.. attr:: providers.[aws]
   ...
   .. attr:: cloud-images
      ...
      .. attr:: image-filters
         ...
         If provided, this is used to select an AMI by filters.
         If the filters provided match more than one image, the most recent
         will be returned. In the case that no image is returned and
         ``image-id`` is provided, ``image-id`` will serve as the fallback.
