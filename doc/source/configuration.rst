...
**optional**
  ...
  ``max-concurrency``
    ...
    limiting the number of threads used by the nodepoold daemon. It can also
    be used to temporarily disable a provider without removing it from the
    config file by setting this value to zero.
