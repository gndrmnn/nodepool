...
The tag ``!include`` will treat the following string as a file, relative
path to the including file, which should be parsed as yaml configuration
data. See ``zmq-publishers`` section for an example.
