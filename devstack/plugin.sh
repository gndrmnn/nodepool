...
EOF
    ...
    if use_library_from_git "glean"; then
        DIB_GLEAN_INSTALLTYPE="DIB_INSTALLTYPE_glean: 'source'"
        DIB_GLEAN_REPOTYPE="DIB_REPOTYPE_glean: 'file'"
        DIB_GLEAN_REPOLOCATION="DIB_REPOLOCATION_glean: 'file://$DEST/glean'"
    fi
