...
EOF
    ...
    if [ -f /etc/ci/mirror_info.sh ] ; then
        ...
        DIB_YUM_MINIMAL_BOOTSTRAP_REPOS_FEDORA="DIB_YUM_MINIMAL_BOOTSTRAP_REPOS: $NODEPOOL_DIB_BASE_PATH/fedora-yum.repos.d"

        mkdir -p $NODEPOOL_DIB_BASE_PATH/fedora-yum.repos.d

        cat <<EOF > $NODEPOOL_DIB_BASE_PATH/fedora-yum.repos.d/dib-mirror-fedora.repo
[fedora]
...
EOF
        ...
        cat <<EOF > $NODEPOOL_DIB_BASE_PATH/fedora-yum.repos.d/dib-mirror-fedora-updates.repo
[updates]
