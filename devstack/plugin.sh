...
EOF
    ...
    NODEPOOL_DEBIAN_SID_MIN_READY=1
    ...
    if $NODEPOOL_PAUSE_DEBIAN_SID_DIB ; then
       NODEPOOL_DEBIAN_SID_MIN_READY=0
    fi
...
labels:
  ...
  - name: debian-sid
    min-ready: $NODEPOOL_DEBIAN_SID_MIN_READY
  - name: fedora-27
...
diskimages:
  ...
  - name: debian-jessie
    ...
    env-vars:
      ...
      $DIB_GLEAN_REPOREF
  - name: debian-sid
    pause: $NODEPOOL_PAUSE_DEBIAN_SID_DIB
    rebuild-age: 86400
    elements:
      - debian-minimal
      - vm
