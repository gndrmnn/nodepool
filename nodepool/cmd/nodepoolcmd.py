...
class NodePoolCmd(NodepoolApp):
    ...
    def create_parser(self):
        ...
        cmd_disable.add_argument('-t', '--timeout', type=int, help='timeout in seconds', required=False)
        ...
        cmd_enable.add_argument('-t', '--timeout', type=int, help='timeout in seconds', required=False)
    ...
    def enable(self):
        timeout = self.args.timeout
        self._change_node_state(zk.READY, timeout=timeout)
