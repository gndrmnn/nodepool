...
class NodePoolCmd(NodepoolApp):
    ...
    def alien_image_list(self):
        results = status.alien_image_list(self.zk,
                                          self.pool,
                                          self.args.provider)
        print(status.output(results, 'pretty'))
    ...
    def info(self):
        ...
        builds = status.info_builds(self.zk, provider_name)
        nodes = status.info_nodes(self.zk, provider_name)
        print("Image builds:")
        print(status.output(builds, 'pretty'))

        print("\nNodes:")
        print(status.output(nodes, 'pretty'))
