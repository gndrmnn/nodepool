...
class NodePoolCmd(object):
    ...
    def parse_arguments(self):
        ...
        cmd_dib_dump_command = subparsers.add_parser(
            'dib-dump-command',
            help='dump a sample command-line for diskimage-builder to '
            'replicate the build of a given image')
        cmd_dib_dump_command.set_defaults(func=self.dib_dump_command)
        cmd_dib_dump_command.add_argument('image_name',
                                          help='image name '
                                          '(from config.yaml:diskimages)'
        cmd_dib_dump_command.add_argument('output',
