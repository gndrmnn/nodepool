...
class OpenStackAdapter(statemachine.Adapter):
    ...
    def __init__(self, provider_config):
        ...
        self.api_executor = ThreadPoolExecutor(max_workers=workers)
    ...
    def listResources(self):
        ...
        # automatic resource cleanup due to lack of metadata, so we
        # call the cleanup methods here.
    ...
    def deleteImage(self, external_id):
        ...
        return self._client.delete_image({'id': external_id})
