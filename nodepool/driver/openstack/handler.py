...
from nodepool.launcher import StatsReporter
from nodepool.launcher import LaunchNodepoolException
from nodepool.launcher import LaunchStatusException
from nodepool.launcher import LaunchNetworkException
from nodepool.launcher import LaunchKeyscanException
...
class OpenStackNodeRequestHandler(NodeRequestHandler):
    log = logging.getLogger("nodepool.driver.openstack.handler."
