    ...
    def _run(self):
        ...
        while attempts <= self._retries:
            try:
                ...
                #
                # TODO(tobiash): while this prevents failed node requests due
                # to quota errors the request handler needs to be paused such
                # such that no further node requests are processed until the
                # quota errors are gone.
