...
class NodeLauncher(threading.Thread, stats.StatsReporter):
    ...
    def _launchNode(self):
        if self._label.diskimage:
            ...
            connection_type = cloud_image.connection_type
            connection_port = cloud_image.connection_port
        ...
        try:
            ...
            if connection_type and connection_type != 'ssh':
                gather_host_keys = False
            else:
                gather_host_keys = True
