        ...
        if instance_requirements:
            ...
            if instance_requirements.get('vcpu-count'):
                ...
                if instance_requirements.get('vcpu-count').get('min'):
                    requirements['VCpuCount']['Min'] = instance_requirements.get('vcpu-count').get('min')

                if instance_requirements.get('vcpu-count').get('max'):
                    requirements['VCpuCount']['Max'] = instance_requirements.get('vcpu-count').get('max')

            if instance_requirements.get('memory-mib'):
                requirements['MemoryMiB'] = {}

                if instance_requirements.get('memory-mib').get('min'):
                    requirements['MemoryMiB']['Min'] = instance_requirements.get('memory-mib').get('min')

                if instance_requirements.get('memory-mib').get('max'):
                    requirements['MemoryMiB']['Max'] = instance_requirements.get('memory-mib').get('max')

            if instance_requirements.get('cpu-manufacturers'):
                requirements['CpuManufacturers'] = instance_requirements.get('cpu-manufacturers')

            if instance_requirements.get('excluded-instance-types'):
                requirements['ExcludedInstanceTypes'] = instance_requirements.get('excluded-instance-types')

            if instance_requirements.get('instance-generations'):
                requirements['InstanceGenerations'] = instance_requirements.get('instance-generations')
