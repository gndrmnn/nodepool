...
class AwsProviderConfig(ProviderConfig):
    ...
    def load(self, config):
        self.profile_name = self.provider.get('profile-name', 'default')
        ...
        for pool in self.provider.get('pools', []):
            ...
            pp.availability_zone = pool.get('availability-zone')
            pp.security_group_id = pool.get('security-group-id')
            pp.subnet_id = pool.get('subnet-id')
