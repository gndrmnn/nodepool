...
class AzureProviderConfig(ProviderConfig):
    ...
    def load(self, config):
        ...
        self.auth_path = self.provider.get(
            'auth_path', os.getenv('AZURE_AUTH_LOCATION', None))
        ...
        for pool in self.provider.get('pools', []):
            ...
            for label in pool.get('labels', []):
                ...
                if cloud_image_name:
                    ...
                    pl.imageReference = cloud_image['imageReference']
    ...
    def getSchema(self):
        ...
        azure_hardware_profile = {
            v.Required('vmSize'): str,
        }

        provider_cloud_images = {
            v.Required('name'): str,
            'username': str,
            v.Required('imageReference'): azure_image_reference,
        }

        azure_label = {
            v.Required('name'): str,
            v.Required('hardwareProfile'): azure_hardware_profile,
        ...
        provider.update({
            ...
            v.Required('resource_group'): str,
            v.Required('resource_group_location'): str,
            v.Required('subnet_id'): str,
            v.Required('cloud-images'): [provider_cloud_images],
            v.Optional('auth_path'): str,
        })
