...
class AnsibleNodeError(Exception):
    pass


class AnsibleNodeProvider(Provider):
    ...
    def checkHost(self, node):
        ...
        try:
            ...
            raise AnsibleNodeError("%s: SSHTimeoutException" % node["name"])
        ...
        raise AnsibleNodeError("%s: host key mismatches (%s)" %
                              (node["name"], keys))
