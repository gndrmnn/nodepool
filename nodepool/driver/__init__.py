...
class Drivers:
    ...
    @staticmethod
    def load_class(driver_name, path, parent_class):
            ...
            for driver in drivers:
                ...
                if not os.path.isdir(driver_path) or \
                   "__init__.py" not in os.listdir(driver_path):
                    continue
                Drivers.log.info("%s: loading driver" % driver_path)
                driver_obj = {}
                for name, parent_class in (
                    ...
                    driver_obj[name] = Drivers.load_class(
    ...
    def get(name):
        ...
        try:
            ...
            Drivers.log.error("%s: unknown driver" % name)
