...
class FakeApi(object):
    ...
    def __init__(self, _configuration, header_name, header_value,
                 cookie, pool_threads):
        pass
...
class FakeCoreClient(object):
    ...
    def list_namespace(self):
        self.api_client.call_api('/api/v1/namespaces', 'GET')
    ...
    def create_namespace(self, ns_body):
        self.api_client.call_api('/api/v1/namespaces', 'POST')
    ...
    def delete_namespace(self, name, body):
        self.api_client.call_api('/api/v1/namespaces/{name}', 'DELETE')
        to_delete = None
