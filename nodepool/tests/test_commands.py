...
class TestNodepoolCMD(tests.DBTestCase):
    ...
    def assert_images_listed(self, configfile, securefile, image_cnt,
                             status="ready"):
        self.patch_argv("-c", configfile, "-s", securefile, "image-list")
    ...
    def test_snapshot_image_update(self):
        ...
        self.patch_argv("-c", configfile, "-s", securefile,
                        "image-update", "fake-provider", "fake-image")
        nodepoolcmd.main()
        self.wait_for_threads()
        self.assert_images_listed(configfile, securefile, 1)
    ...
    def test_dib_snapshot_image_update(self):
        ...
        nodepoolcmd.main()
        self.wait_for_threads()
        self.assert_images_listed(configfile, securefile, 2)
    ...
    def test_image_delete_snapshot(self):
        ...
        nodepoolcmd.main()
        self.wait_for_threads()
        self.assert_images_listed(configfile, securefile, 0)
    ...
    def test_alien_list_fail(self):
        ...
        configfile = self.setup_config("node_cmd.yaml")
        securefile = self.setup_secure()
        self.patch_argv("-c", configfile, "-s", securefile, "alien-list")
        nodepoolcmd.main()
        self.wait_for_threads()
