...
class TestLauncher(tests.DBTestCase):
    ...
    def test_ignore_quota_true(self):
        '''
        ...
        configfile = self.setup_config('ignore_quota_true.yaml')
        self.useBuilder(configfile)
        self.waitForImage('fake-provider', 'fake-image')
        ...
        # Create a request with ignore-quota set to true that should pass
        # regardless of the lack of cloud quota.
