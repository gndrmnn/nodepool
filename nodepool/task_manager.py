...
class TaskWorker(threading.Thread):
    ...
    def __init__(self, name, stats_name, rate, queue):
        super(TaskWorker, self).__init__(name=name, stats_name=stats_name)
        self.daemon = True
        self.queue = queue
        self._running = True
        self.name = name
...
class TaskManager(object):
    ...
    def __init__(self, client, name, rate):
        ...
        self.main_worker = TaskWorker(
            name + '_main', name, rate, self.main_queue)
        self.second_worker = TaskWorker(
            name + '_slow', name, rate, self.second_queue)
        self.name = name
        self._client = None
