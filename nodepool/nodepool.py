        ...
        for ntype in self.request.node_types:
            ...
            if self.request.reuse and ntype in ready_nodes:
                for node in ready_nodes[ntype]:
                    ...
                    # Group by AZ, using this node's AZ for the rest of the
                    # node set if an AZ has not already been chosen.
                    if not chosen_az and node.az:
                        chosen_az = node.az
                    elif chosen_az and node.az != chosen_az:
                        continue
                    ...
                    try:
                        ...
                        # If we didn't have any AZs to choose from, select the
