...
class UploadWorker(BaseWorker):
    ...
    def _uploadImage(self, build_id, images, provider):
        '''
        ...
        if not image:
            raise BuilderInvalidCommandError(
    ...
    def _checkForProviderUploads(self):
        ...
        for provider in self._config.providers.values():
            for image in provider.images.values():
                ...
                # Search for locally built images
                ...
                try:
                    with self._zk.imageUploadLock(
                        ...
                        data = self._uploadImage(build[0], local_images, provider)
