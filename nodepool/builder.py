...
DiskImageConfig = namedtuple('DiskImage',
...
class NodePoolBuilder(object):
    ...
    def parse_config(self, config_path):
        ...
        for diskimage in config.get('diskimages', ()):
            ...
            diskimage = DiskImageConfig(name=name, elements=elements,
    ...
    def _register_existing_image_uploads(self, worker):
        images = DibImageFile.from_images_dir(self.images_dir)
        for image in images:
    ...
    def _delete_image(self, image_id):
        image_files = DibImageFile.from_image_id(self.images_dir, image_id)

        # Delete a dib image and it's associated file
        for image_file in image_files:
            img_path = image_file.to_path(self.images_dir)
    ...
    def _upload_image(self, image_id, provider_name):
        ...
        filename = image_file.to_path(self.images_dir,
    ...
    def _build_image(self, image_name):
        ...
        filename = image_file.to_path(self.images_dir, False)
