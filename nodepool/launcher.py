...
class PoolWorker(threading.Thread, stats.StatsReporter):
    ...
    def _assignHandlers(self, timeout=15):
        ...
        for req in requests:
            ...
            request_tenant_name = req.requestor_data.get("tenant_name")
            check_tenant_quota = request_tenant_name and request_tenant_name \
    ...
    def _hasTenantQuota(self, request, provider_manager):
        ...
        '''
        tenant_name = request.requestor_data["tenant_name"]
