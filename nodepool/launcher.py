...
class InstanceDeleter(threading.Thread, stats.StatsReporter):
...
class PoolWorker(threading.Thread):
    ...
    def get_node_request_handler(self, provider, request):
    ...
    def _assignHandlers(self):
        ...
        for req_id in self.zk.getNodeRequests():
            ...
            rh = self.get_node_request_handler(provider, req)
            rh.run()
            if rh.paused:
