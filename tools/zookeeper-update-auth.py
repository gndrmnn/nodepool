...
parser.add_argument("-c", dest="config", default="/etc/nodepool/nodepool.yaml",
                    help="path to config file")
parser.add_argument("-s", dest="secure", default="/etc/nodepool/secure.conf",
                    help="path to secure file")
parser.add_argument("--chroot", default="/nodepool", help="zookeeper root node")
...
input("Press enter to confirm updating zookeeper ACL: ")
