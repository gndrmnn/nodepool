...
NODEPOOL_PAUSE_OPENSUSE_42_3_DIB=${NODEPOOL_PAUSE_OPENSUSE_42_3_DIB:-true}
...
if [ $NODEPOOL_PAUSE_OPENSUSE_42_3_DIB = 'false' ]; then
    # check that image built
    waitforimage opensuse-42.3
    # check image was bootable
    waitfornode opensuse-42.3
    # check ssh for root user
    sshintonode opensuse-42.3
fi
